...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 20, 2018 at 01:40 AM
...
(1, 'admin', 'admin', '2018-01-01', 'admin@gmail.com', '25A63380FB53D3B5310B7B6870F23CD9', '2018-08-13', 1, '2018-08-18'),
(4, 'Cabral', 'cabralzin', '2018-08-01', 'cabral@gmail.com', '4FCF68DFE7532C8F79C3E6FF693F6DBE', '2018-08-18', 1, NULL),
(5, 'Eduardo', 'duduzin', '2018-08-01', 'eduaugustocardozo@gmail.com', 'B53A4F423DCA5607E4FFD77C773ECB50', '2018-08-18', 1, NULL),
(6, 'Nones', 'nonezinho', '2018-08-01', 'nones@gmail.com', '4FCF68DFE7532C8F79C3E6FF693F6DBE', '2018-08-18', 1, NULL),
(7, 'player', 'player1', '2018-08-01', 'player@gmail.com', '25A63380FB53D3B5310B7B6870F23CD9', '2018-08-18', 0, '2018-08-19'),
(8, 'player', 'player2', '2018-08-01', 'player@gmail.com2', '25A63380FB53D3B5310B7B6870F23CD9', '2018-08-18', 0, NULL);
...
--
ALTER TABLE `usuarios`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Armazena o id de cada usuário cadastrado', AUTO_INCREMENT=31;
